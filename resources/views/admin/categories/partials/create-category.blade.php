    ...
    <div class="bg-white rounded-lg p-8 max-w-2xl w-full shadow-lg">
        ...
        <form id="createCategoryForm" action="{{ route('categories.store') }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="description" id="create-category-description" rows="4" required class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm" placeholder="Enter your category description"></textarea>
